...
(((window, undefined) => {
    ...
    jQuery.extend({
        ...
        Deferred(func) {
            ...
            var promise = {
				...
				always(...args) {
					return deferred.done(...args).fail.apply( deferred, args );
				},
    ...
    jQuery.support = ((() => {
        ...
        offsetSupport = (((body, container) => {
            ...
            var ptlm = "position:absolute;top:0;left:0;width:1px;height:1px;margin:0;";
            var style = "style='" + ptlm + "border:5px solid #000;padding:0;'";

            var html = "<div " + style + "><div></div></div>" +
    ...
    jQuery.fn.extend({
        ...
        delay(time, type) {
            ...
            return this.queue( type, (next, runner) => {
    ...
    var quickIs = (elem, m) => (!m[1] || elem.nodeName.toLowerCase() === m[1]) &&
    (!m[2] || elem.id === m[2]) &&
    ...
    function dispatch( target, event, handlers, args ) {
        ...
        var specialHandle = ( jQuery.event.special[ event.type ] || {} ).handle;
        var j;
        var handleObj;
        var ret;
    ...
    jQuery.each({
        ...
        jQuery.fn[ name ] = function( until, selector ) {
            ...
            var // The variable 'args' was introduced in
    ...
    jQuery.each(
        ( "doesAddBorderForTableAndCells doesNotAddBorder " +
            ...
            "supportsFixedPosition" ).split(" "), (i, prop) => {
